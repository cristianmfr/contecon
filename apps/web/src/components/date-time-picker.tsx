...
export function DateTimePicker<T extends FieldValues>({ control, name, onChangeCustom }: DateTimePickerProps<T>) {
        ...
        return (
          <Popover modal>
            <PopoverTrigger asChild>
              ...
              >
                {value ? format(value, 'dd/MM/yyyy HH:mm', { locale: ptBR }) : <span>DD/MM/AAAA</span>}
