...
export function SelectBanksClient({ banks, setFormValue, isLoading = false, defaultValue }: Props) {
      ...
      <PopoverTrigger asChild>
        <Button variant='outline' role='combobox' aria-expanded={open} className='w-full justify-between'>
          {value ? (
            ...
            <span className='text-muted-foreground font-normal'>Selecione um banco</span>
          )}
