...
import { Tooltip, TooltipContent, TooltipTrigger } from '@contecon/ui/components/tooltip'
...
const CalendarDayView = () => {
  ...
  return (
    <div className='flex relative pt-2 overflow-auto h-full no-scrollbar'>
      <TimeTable />
...
const CalendarWeekView = () => {
  ...
  return (
    <div className='flex flex-col relative overflow-auto h-full no-scrollbar'>
...
const CalendarMonthView = ({ onEventClick }: { onEventClick?: (eventId: string) => void }) => {
  ...
  return (
    <div className='h-full flex flex-col'>
      <div className='grid grid-cols-7 gap-px sticky top-0 bg-transparent border-b'>
        {weekDays.map((day, i) => (
          <div
            key={day}
            className={cn(
              ...
              {currentEvents.map((event) => {
                return (
                  <Tooltip key={event.id}>
                    <TooltipTrigger asChild>
                      ...
                      >
                        <div
                          ...
                          style={{ backgroundColor: event.identifierColor }}
                        ></div>
                    ...
                    <TooltipContent className='w-64 py-3 px-4 rounded-lg shadow-sm'>
...
const CalendarYearView = () => {
  ...
  return (
    <div className='grid grid-cols-4 gap-10 overflow-auto h-full no-scrollbar'>
      {months.map((days, i) => (
