  ...
  return (
    <div className='grid gap-4 w-full'>
      ...
      <div className='grid grid-cols-3 gap-2'>
        <div className='flex flex-col gap-2'>
          <Label>Início</Label>
          <DateTimePicker name='startDate' control={control} onChangeCustom={(date) => setValue('startDate', date)} />
        </div>
        <div className='flex flex-col gap-2'>
          <Label>Término</Label>
          <DateTimePicker name='endDate' control={control} onChangeCustom={(date) => setValue('endDate', date)} />
        </div>
        <SelectField
