...
export type CreateNewPasswordFormSchemaType = z.infer<typeof createNewPasswordFormSchema>
...
export function CreateNewPasswordForm({ register, errors }: CreateNewPasswordFormData) {
  return (
