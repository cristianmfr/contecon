...
export function useSearchParams(): UseSearchParamsReturn {
  ...
  function setParam(key: string, value: string | number | boolean | null | undefined): void {
    const searchParams = getSearchParams()
  ...
  function setParams(params: Record<string, string | number | boolean | null | undefined>): void {
    const searchParams = getSearchParams()
