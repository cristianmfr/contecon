...
import { EntryForm, EntryPayload, entrySchema } from '@/src/components/forms/entry/form'
    ...
    <PageLayout>
      ...
      <Card>
        ...
        <CardFooter className='gap-2 justify-end'>
          ...
          <Button type='button' disabled={loading} loading={loading} onClick={handleSubmit(handleCreateEntry)}>
            Adicionar
          </Button>
        </CardFooter>
      </Card>
